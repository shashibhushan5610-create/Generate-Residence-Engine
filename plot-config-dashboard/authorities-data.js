        ...
        "UP_2025": {
            ...
            "rules": {
                "Residential": {
                    ...
                    "maxGroundCoverage": 60,
                    "telescopicFAR": [
                        { "limit": 150, "multiplier": 2.00 },
                        { "limit": 150, "multiplier": 1.80 },
                        { "limit": 200, "multiplier": 1.75 },
                        { "limit": 700, "multiplier": 1.50 },
                        { "limit": Infinity, "multiplier": 1.25 }
                    ],
                    "maxPurchasableFAR": { "tiny": 2.25, "regular": 2.50 },
                    "parking": [
                        { "max": 100, "ecs": 1.0 },
                        { "max": 150, "ecs": 1.25 },
                        { "max": Infinity, "ecs": 1.50 }
                    ],
                    "areaThresholds": [
